...
public class EditarAdministrador implements Command{
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (service.editar(adm)) {
                request.setAttribute("mensagem", "Administrador atualizado com sucesso!");
                request.getRequestDispatcher("administrador/paginaDeResposta.jsp").forward(request, response);
            } else {
                request.setAttribute("mensagem", "Erro ao tentar atualizar Administrador!");
                request.getRequestDispatcher("administrador/paginaDeResposta.jsp").forward(request, response);
            }
